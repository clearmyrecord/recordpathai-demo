(function () {
  ...
  const dictionary = {
    en: {
      ...
      'footer.legal': 'RecordPathAI is not a law firm and does not provide legal advice. Eligibility results are estimates based on information provided by the user and applicable rules. Court filing fees, attorney fees, and other third-party costs are separate from RecordPathAI services.',
      'footer.terms': 'Terms',
      ...
      'record.optionalArrestBookingTitle': 'Optional Arrest / Booking Details',
      'record.optionalArrestBookingHelper': 'Most users can skip this section. RecordPathAI uses your court, case, charge, and completion details to estimate eligibility and generate your packet. Arrest and booking details are optional tracking information.',
      'record.arrestDate': 'Arrest Date',
      'record.arrestingAgency': 'Arresting Agency',
      'record.arrestingAgencyPlaceholder': 'Arresting agency',
      'record.detentionFacility': 'Jail / Detention Facility',
      'record.detentionFacilityPlaceholder': 'Jail or detention facility',
      'record.bookingNumber': 'Booking Number',
      'record.bookingNumberPlaceholder': 'Booking number',
      'record.arrestCounty': 'Arrest County',
      'record.arrestState': 'Arrest State',
    ...
    es: {
      ...
      'footer.legal': 'RecordPathAI no es un bufete de abogados y no brinda asesoría legal. Los resultados de elegibilidad son estimaciones basadas en la información proporcionada por el usuario y las reglas aplicables. Las tarifas de presentación judicial, los honorarios de abogados y otros costos de terceros son independientes de los servicios de RecordPathAI.',
      ...
      'record.optionalArrestBookingTitle': 'Detalles opcionales de arresto / registro',
      'record.optionalArrestBookingHelper': 'La mayoría de los usuarios puede omitir esta sección. RecordPathAI usa los datos del tribunal, caso, cargo y finalización para estimar la elegibilidad y generar su paquete. Los datos de arresto y registro son información opcional de seguimiento.',
      'record.arrestDate': 'Fecha de arresto',
      'record.arrestingAgency': 'Agencia que realizó el arresto',
      'record.arrestingAgencyPlaceholder': 'Agencia que realizó el arresto',
      'record.detentionFacility': 'Cárcel / Centro de detención',
      'record.detentionFacilityPlaceholder': 'Cárcel o centro de detención',
      'record.bookingNumber': 'Número de registro',
      'record.bookingNumberPlaceholder': 'Número de registro',
      'record.arrestCounty': 'Condado del arresto',
      'record.arrestState': 'Estado del arresto',
